...
class ProductControllerSeller extends Controller
{
    ...
    public function createVariant($productId)
    {
        ...
        return view('seller.products.create-variant', compact('product', 'attributes', 'variants'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('seller.products.edit', compact('product', 'categories', 'brands', 'attributes'));
    }
