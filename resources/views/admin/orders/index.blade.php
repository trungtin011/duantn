            ...
            <thead class="text-gray-300 font-semibold border-b border-gray-100">
                <tr>
                    <th class="w-6 py-3 pr-6">
                        <input id="select-all" class="w-[18px] h-[18px]" aria-label="Chọn tất cả đơn hàng"
                            type="checkbox" />
                    </th>
                ...
                @foreach ($orders as $order)
                    <tr data-order-id="{{ $order->id }}">
                        ...
                        <td class="py-4">
                            ...
                            @endphp
                            <span
                                class="inline-block {{ $statusClass }} text-[10px] font-semibold px-2 py-0.5 rounded-md select-none">
                                {{ $statusText }}
                            </span>
                        </td>
