...
@section('content')
    <div class="admin-page-header">
        ...
        <div class="admin-breadcrumb">
            <a href="#" class="admin-breadcrumb-link">Trang chủ</a> / Mã giảm giá
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="admin-card">
                <div class="mb-3 flex justify-between items-center">
                    <form action="{{ route('admin.coupon.index') }}" method="GET" class="flex items-center">
                        <input type="text" name="search" value="{{ request('search') }}"
                            placeholder="Tìm kiếm mã giảm giá..." class="form-control me-2" style="width: 200px;">
                        <button type="submit"
                        ...
                        <thead class="text-gray-300 font-semibold border-b border-gray-100">
                            <tr>
                                <th class="w-6 py-3 pr-6">
                                    <input id="select-all" class="w-[18px] h-[18px]" aria-label="Select all coupons"
                                        type="checkbox" />
                                </th>
                                ...
                                <tr>
                                    <td class="py-4 pr-6">
                                        <input class="select-item w-[18px] h-[18px]"
                                            aria-label="Select {{ $coupon->code }}" type="checkbox" />
                                    </td>
                                    ...
                                    <td class="py-4 text-[13px]">{{ ucfirst($coupon->status) }}</td>
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div class="text-muted text-sm">Hiển thị {{ $coupons->count() }} trên {{ $coupons->total() }}</div>
