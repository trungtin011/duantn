...
@section('account-content')
    <div class="container mx-auto px-4">
        <!-- Wishlist Section -->
        <div class="">
            <h2 class="text-xl sm:text-2xl font-bold mb-4">Danh sách yêu thích</h2>
                        ...
                        <div class="relative bg-white rounded-lg overflow-hidden w-fit">
                            <div
                                ...
                                <div class="flex items-center justify-center w-full h-full p-5 sm:p-7 lg:p-[50px]">
                                    <img src="{{ $item->product->images->isNotEmpty() ? asset('storage/' . $item->product->images->first()->image_path) : asset('images/placeholder.png') }}"
                    ...
                    forms.forEach(form => {
                        form.addEventListener('submit', function(e) {
                            ...
                            fetch('{{ route('cart.add') }}', {
                                ...
                                .then(data => {
                                    alert(data.message); // hoặc toastr/sweetalert
                                })
                                .catch(error => {
        ...
        <div class="recommendations-section">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-7 lg:gap-[40px]">
                @foreach (\App\Models\Product::inRandomOrder()->take(4)->with('images')->get() as $product)
                    <div class="relative bg-white rounded-lg overflow-hidden w-fit">
                        <div
                            class="relative bg-[#F5F5F5] w-full sm:w-[280px] lg:w-[300px] h-[230px] sm:h-[280px] lg:h-[300px] mx-auto">
