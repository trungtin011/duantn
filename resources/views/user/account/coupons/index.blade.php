...
<div class="bg-white rounded-lg shadow-sm border">
    <div class="px-4 sm:px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 justify-between">
        <div>
                    ...
                    <div class="border rounded-lg p-4 flex gap-4 items-start">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2">
                                <h3 class="font-semibold text-gray-900 truncate">{{ $coupon->name ?? $coupon->code }}</h3>
                                @if($item->status === 'used')
                                ...
                                @else
                                    <span class="text-xs px-2 py-0.5 rounded-full bg-green-100 text-green-600">Có thể dùng</span>
                                @endif
                            </div>
