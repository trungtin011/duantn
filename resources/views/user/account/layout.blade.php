                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-8">
                    ...
                    <div>
                        ...
                        @php
                            ...
                            $nextThreshold =
                                $nextRankIndex < count($ranks)
                                    ? $ranks[array_keys($ranks)[$nextRankIndex]]['min']
                                    : $currentMax;
                        ...
                        <div class="relative w-full bg-gray-200 rounded-full h-8 overflow-hidden">
                            ...
                            <div
                                class="absolute inset-0 flex items-center justify-between px-3 text-xs text-black font-medium">
