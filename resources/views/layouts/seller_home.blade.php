...
<body class="bg-[#f5f5f7] text-[#222222] text-sm leading-relaxed font-[Inter]">
    <header class="flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-white sticky top-0 z-30">
        <div class="flex items-center space-x-1">
            <img alt="Shopee logo orange square with white S letter" class="w-6 h-6" height="24" src="https://storage.googleapis.com/a1aa/image/85613291-9ad9-4179-6ad5-12944deb52ae.jpg" width="24"/>
    ...
    <div class="flex">
        <nav class="w-56 bg-white border-r border-gray-200 px-4 py-4 text-xs text-gray-500 select-none overflow-y-auto" style="max-height: calc(100vh - 40px)">
            <ul class="space-y-4">
                <li>
                    <button aria-expanded="true" class="flex flex-col items-start w-full font-semibold text-gray-400" type="button">
                        Quản Lý Đơn
                    ...
                    <ul class="mt-2 space-y-1 pl-3 text-gray-700 font-normal">
                        ...
                        <li><a class="block hover:text-orange-500" href="#">Đơn Trả hàng/Hoàn tiền hoặc Đơn hủy</a></li>
                ...
                <li>
                    ...
                    <ul class="mt-2 space-y-1 pl-3 text-gray-700 font-normal">
                        <li><a class="block hover:text-orange-500" href="#">Tất Cả Sản Phẩm</a></li>
                        <li><a class="block hover:text-orange-500" href="#">Thêm Sản Phẩm</a></li>
                    </ul>
                </li>
                <li>
                    <button aria-expanded="true" class="flex flex-col items-start w-full font-semibold text-gray-400" type="button">
