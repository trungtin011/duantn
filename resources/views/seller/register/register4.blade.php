            ...
            <div class="p-8">
                <div class="text-center space-y-8">
                    ...
                    <div class="flex justify-center">
                        <div class="w-24 h-24 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full flex items-center justify-center shadow-2xl">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1 text-left">
                                    ...
                                    <div class="text-sm text-gray-600">Thông tin của bạn đã được gửi đến bộ phận xác thực</div>
                                </div>
                            </div>
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1 text-left">
                                    ...
                                    <div class="text-sm text-gray-600">Quá trình xác thực sẽ diễn ra trong vòng 3-4 ngày làm việc</div>
                                </div>
                            </div>
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1 text-left">
                                    ...
                                    <div class="text-sm text-gray-600">Bạn sẽ nhận được thông báo qua email khi xác thực hoàn tất</div>
                                </div>
                            </div>
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1 text-left">
                                    ...
                                    <div class="text-sm text-gray-600">Sau khi được phê duyệt, bạn có thể bắt đầu đăng sản phẩm</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="text-center text-xs text-gray-500 space-y-1 pt-8 border-t border-gray-200">
                        <p>Mã đăng ký: <span class="font-mono bg-gray-100 px-2 py-1 rounded">{{ time() }}</span></p>
