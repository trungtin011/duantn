...
@section('content')
    <div class="admin-page-header mb-5">
        ...
        <div class="admin-breadcrumb"><a href="{{ route('seller.coupon.index') }}" class="admin-breadcrumb-link">Mã giảm giá</a> / Thêm mới</div>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-8">
            <form action="{{ route('seller.coupon.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea class="form-control @error('description') border-red-500 @enderror" id="description" name="description" rows="2" placeholder="Mô tả ngắn về mã giảm giá">{{ old('description') }}</textarea>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" class="form-control @error('discount_value') border-red-500 @enderror" id="discount_value" name="discount_value" value="{{ old('discount_value') }}" step="0.01" placeholder="Nhập giá trị">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" class="form-control @error('max_discount_amount') border-red-500 @enderror" id="max_discount_amount" name="max_discount_amount" value="{{ old('max_discount_amount') }}" step="0.01" placeholder="Tối đa (nếu có)">
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control @error('min_order_amount') border-red-500 @enderror" id="min_order_amount" name="min_order_amount" value="{{ old('min_order_amount') }}" step="0.01" placeholder="Tối thiểu (nếu có)">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" class="form-control @error('max_uses_per_user') border-red-500 @enderror" id="max_uses_per_user" name="max_uses_per_user" value="{{ old('max_uses_per_user') }}" placeholder="Tối đa/người">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" class="form-control @error('max_uses_total') border-red-500 @enderror" id="max_uses_total" name="max_uses_total" value="{{ old('max_uses_total') }}" placeholder="Tổng số lần">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" class="form-control @error('start_date') border-red-500 @enderror" id="start_date" name="start_date" value="{{ old('start_date') }}" placeholder="YYYY-MM-DD">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control @error('end_date') border-red-500 @enderror" id="end_date" name="end_date" value="{{ old('end_date') }}" placeholder="YYYY-MM-DD">
                        <div class="text-xs text-gray-400 mt-1">Định dạng: YYYY-MM-DD</div>
                ...
                <div class="flex justify-end gap-2 mt-6">
                    ...
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded-md transition-all duration-300 font-semibold">Thêm mã giảm giá</button>
                </div>
            </form>
        </div>
    </div>
