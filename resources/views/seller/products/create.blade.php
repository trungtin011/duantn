                        ...
                        <div class="w-full lg:w-2/3">
                            ...
                            <div class="bg-white p-6 rounded-lg shadow-sm mb-6">
                                ...
                                <div id="product-fields">
                                    ...
                                    <div class="variable-product-fields hidden">
                                        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
                                            <div>
