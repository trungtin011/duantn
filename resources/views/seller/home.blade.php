...
@section('content')
    <div class="flex min-h-[calc(100vh-40px)]">
        <main class="flex-1 p-4 space-y-6 overflow-y-auto">
            <section
                class="bg-white rounded-lg p-4 shadow-sm flex flex-col sm:flex-row justify-between text-center sm:text-left space-y-4 sm:space-y-0 sm:space-x-10">
            ...
            <section class="bg-white rounded-lg p-4 shadow-sm space-y-3">
                ...
                <div
                    class="grid grid-cols-5 text-center text-gray-600 text-xs font-normal border-t border-b border-gray-200 py-3">
                    <div>
                        <div class="flex justify-center items-center space-x-1"><span>Doanh số</span><i
                    ...
                    <div>
                        <div class="flex justify-center items-center space-x-1"><span>Lượt truy cập</span><i
                                class="fas fa-question-circle text-[10px]"></i></div>
                        <div class="font-semibold text-base mt-1">0</div>
                        <div class="text-gray-400 text-[10px] mt-0.5">- 0,00%</div>
                    </div>
                    <div>
                        <div class="flex justify-center items-center space-x-1"><span>Lượt xem</span><i
                                class="fas fa-question-circle text-[10px]"></i></div>
                        <div class="font-semibold text-base mt-1">0</div>
                        <div class="text-gray-400 text-[10px] mt-0.5">- 0,00%</div>
                    </div>
                    ...
                    <div>
                        <div class="flex justify-center items-center space-x-1"><span>Tỷ lệ chuyển đổi</span><i
                                class="fas fa-question-circle text-[10px]"></i></div>
            ...
            <section class="bg-white rounded-lg p-4 shadow-sm space-y-3">
                ...
                <div class="border border-gray-200 rounded-md p-3 text-gray-600 text-xs relative"
                    ...
                    <div class="flex items-center space-x-2 mb-1">
                        <img alt="Advertisement icon red circle with white AD letters" class="w-4 h-4" height="16"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <section class="bg-white rounded-lg p-4 shadow-sm space-y-3 lg:col-span-2 min-h-[300px]">
                    <div class="flex justify-between items-center">
                        ...
                        <a class="text-blue-600 text-xs font-normal hover:underline whitespace-nowrap" href="#">Thêm
                            <i class="fas fa-chevron-right text-[10px]"></i></a>
                    </div>
                    <div class="mt-6 flex justify-center">
                        <svg class="animate-spin h-6 w-6 text-[#ff4d4f]" fill="none" viewBox="0 0 24 24"
            ...
            <aside class="w-72 flex flex-col space-y-6">
                <section class="bg-white rounded-lg p-4 shadow-sm text-gray-700 text-sm" style="min-height: 100px">
                    ...
                    <a class="text-blue-600 text-xs font-normal flex justify-between items-center hover:underline"
                        href="#"><span>Xuất sắc</span><i class="fas fa-chevron-right text-[10px]"></i></a>
                ...
                <section class="bg-white rounded-lg p-4 shadow-sm text-gray-700 text-sm" style="min-height: 320px">
                    ...
                    <div class="space-y-4">
                        <div class="border border-gray-200 rounded p-3">
                            ...
                            <button
                                class="text-xs text-[#ff4d4f] border border-[#ff4d4f] rounded px-2 py-0.5 hover:bg-[#ff4d4f] hover:text-white transition-colors">Bắt
                                đầu</button>
                        </div>
                        <div class="border border-gray-200 rounded p-3">
                        ...
                        <div class="border border-gray-200 rounded p-3">
                            <h4 class="font-semibold text-xs mb-1">Hoàn thành khóa học Đạt được đơn hàng đầu tiên của bạn
                            </h4>
                        </div>
                    </div>
                </section>
        ...
        <div class="fixed right-4 top-1/2 -translate-y-1/2 flex flex-col items-center space-y-4 z-40"
            ...
            <button aria-label="Chat message"
                class="w-8 h-8 rounded-full bg-[#ff4d4f] text-white flex items-center justify-center shadow-md hover:brightness-90 transition">
